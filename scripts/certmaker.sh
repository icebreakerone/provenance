...
openssl req -new -key 6-honest-daves-accurate-meter-readings-key.pem -out 6-honest-daves-accurate-meter-readings-csr.pem \
    -subj "/C=GB/ST=London/O=Honest Dave's Accurate Meter Reading Co/CN=https:\/\/directory.core.pilot.trust.ib1.org\/member\/2876152"
...
openssl req -new -key 7-emission-calculations-4-u-key.pem -out 7-emission-calculations-4-u-csr.pem \
    -subj "/C=GB/ST=London/O=Emission Calculations 4 U/CN=https:\/\/directory.core.pilot.trust.ib1.org\/member\/81524"
...
openssl req -new -key 8-green-bank-of-london-key.pem -out 8-green-bank-of-london-csr.pem \
    -subj "/C=GB/ST=London/O=Green Bank of London/CN=https:\/\/directory.core.pilot.trust.ib1.org\/member\/71212388"
